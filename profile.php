<?php
  ...
  if (isset($_SESSION['user'])) {
    ...
    $getUser = $con->prepare("SELECT * FROM users WHERE Username = '$sessionUser'");
...
<div id="my-ads" class="my-ads block">
  <div class="container">
    <div class="panel panel-primary">
      ...
      <div class="panel-body">
            <?php
               $myItems = getAllfrom("*", "items", "where ID_user = $userid", "", "ID_item");
               //$items   = getItems('ID_user' ,$info['ID_user']);
                 if (!empty($myItems)) {
                   echo "<div class='row'>";
     ...
     <div class="panel panel-primary">
        ...
        <div class="panel-body">
           <?php
             ...
             $myComments = getAllFrom("comment", "comments", "where ID_user = $userid", "", "ID_comment", "ASC");
